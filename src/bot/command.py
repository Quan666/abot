...
from src.bot.change import change_list
from src.bot.delete import delete_handle
...
from src.bot.lib import CancelInput, CommandInfo, InputText, buttons_layout
from src.bot.permission import handle_permission
from src.bot.query import query_list
from src.bot.utils import subscription_telegram_message_text
from config import config
from src.database import add_subscription, load_subscriptions
...
class StratCommands:
    ...
    unsubscribe = CommandInfo(
        name="删除订阅", command="unsubscribe", description="删除订阅"
    )
